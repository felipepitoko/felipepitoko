...
<section class="mb-8">
        ...
        <section class="text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="https://linkedin.com/in/felipeCostaPy" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105">
                    LinkedIn
                </a>
                        <br>
